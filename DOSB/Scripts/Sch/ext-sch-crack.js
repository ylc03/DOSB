    ...
    Sch.HorizontalSchedulerView = Ext.extend(Sch.AbstractSchedulerView, {
		...
		constructor: function (a) {
			Sch.HorizontalSchedulerView.superclass.constructor.call(this, a);if (this.forceFit) {this.refresh = this.refresh.createInterceptor(function () {this.fitColumns(true);});}
		}, 
		onEventAdd: function (s, a) {
			var b;
			for (var i = 0, l = a.length; i < l; i++) {
				b = this.grid.getResourceByEventRecord(a[i]);
				if (b) {this.refreshRow(b);}
			}
		}, 
