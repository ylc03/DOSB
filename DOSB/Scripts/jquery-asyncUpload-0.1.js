...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            container.append($("<span id='" + id + "_uploading'>Uploading... <input type='button' value='Cancel Upload' /></span>"));
            ...
            var defaults = {
                ...
                button_text: "<font face='\"Segoe UI\",Arial,sans-serif' size='12pt'>Choose file</font>",
